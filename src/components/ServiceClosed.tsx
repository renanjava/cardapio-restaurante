  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 text-center animate-fade-in">
      ...
      <p className="text-muted-foreground max-w-md mx-auto mb-8 text-lg">
        Nosso horário de funcionamento é das <span className="font-semibold text-primary">{RESTAURANT_INFO.openingHours.openingTime}</span> às <span className="font-semibold text-primary">{RESTAURANT_INFO.openingHours.closingTime}</span>.
        <br />
